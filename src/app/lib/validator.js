...
import { ValidatorToggle } from '../components/ValidatorToggle';
...
export class Validator {
	...
	setReport(report, response) {
		...
		this.toggleEl.innerHTML = ValidatorToggle({ issues: report.issues });
		this.showToggle();
		this.bindListeners();
	...
	setReportException(e) {
		this.report = null;
		this.toggleEl.innerHTML = ValidatorToggle({ reportError: e });
		this.showToggle();
		this.bindListeners();
	}
	...
	showLightbox() {
		...
		tab.document.body.innerHTML = `
			...
			<style>
				...
				h1 { color: #333; }
				.validation-report { max-width: 800px; }
			</style>

	...
	return `
		<div class="report">
			...
			<ul>
				...
				${info?.extras?.title ? `
					<li>
						<b>Title:</b> ${info.extras.title}
					</li>
				` : ''}
				${info?.extras?.author ? `
					<li>
						<b>Author:</b> ${info.extras.author}
					</li>
				` : ''}
				${info?.extras?.license ? `
					<li>
						<b>License:</b> ${info.extras.license}
					</li>
				` : ''}
				${info?.extras?.source ? `
					<li>
						<b>Source:</b> ${info.extras.source}
					</li>
				` : ''}
				<li>
					<b>Stats:</b>
				...
				<li>
					...
					<ul>
						${info.extensionsUsed?.length ? 
							info.extensionsUsed.map(extension => `<li>${extension}</li>`).join('') :
							'<li>None</li>'
						}
					</ul>
					${info.extensionsUsed?.length ? `
